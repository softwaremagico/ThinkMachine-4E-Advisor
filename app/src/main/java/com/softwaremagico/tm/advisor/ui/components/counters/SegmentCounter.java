...
public abstract class SegmentCounter extends Counter {
    ...
    private final int gear2Color = R.color.icons_color;
    private final int text2Color = R.color.md_theme_primaryContainer;
    ...
    private void setCustomColor() {
        if (getTotalValue() < 0) {
            valueText2.setTextColor(ContextCompat.getColor(getContext(), R.color.md_theme_onPrimaryContainer));
