...
public class TranslatedNumberPicker<T extends Element> extends ElementComponent<T> {
    ...
    protected void setEnabled() {
        ...
        picker.setEnabled(!element.getRestrictions().isRestricted(CharacterManager.getSelectedCharacter()));
    }
