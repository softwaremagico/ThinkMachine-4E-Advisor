...
public class LoadCharacter extends DialogFragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        final Button closeButton = rootView.findViewById(R.id.close_button);
        closeButton.setOnClickListener(v -> dismiss());

        //RECYCLER
        final RecyclerView mRecyclerView = rootView.findViewById(R.id.character_recycler_loader);
        ...
        backgroundExecutor.execute(() -> {
            ...
            getActivity().runOnUiThread(() -> {
                ...
                //ADAPTER
                final CharacterRecyclerViewAdapter mAdapter = new CharacterRecyclerViewAdapter(loadedCharacterEntities);
